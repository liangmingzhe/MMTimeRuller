...
@interface MMRullerHeadView() {
    CGContextRef ctx;
    UIColor *fillColor;
    UIColor *lineColor;
}
@end
@implementation MMRullerHeadView
...
- (void)drawRect:(CGRect)rect {
    [self drawRetangleViewWithRect:CGRectMake(self.frame.size.width, self.frame.size.height - 15 - 10, 1.5, 15) tag:[NSString stringWithFormat:@"00:00"]];
}
